...
import { parseChangedLines, parseHunks } from '@/lib/diff/patchDiff';
import type { DiffLine }                 from '@/lib/diff/prDiffTypes';
import { annotateLinePair }              from '@/lib/diff/wordDiff';
import { highlightLines }                from '@/lib/theme/highlight';
