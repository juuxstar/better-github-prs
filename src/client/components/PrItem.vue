    ...
    <div class="pr-content u-flex-1 u-min-w-0">
      ...
      <div class="pr-meta u-flex u-items-center u-gap-2 u-fs-13 u-text-tertiary u-flex-wrap">
        ...
        <template v-if="pr.comments > 0">
          <span class="pr-meta-sep">&middot;</span>
          <span class="pr-comments u-flex u-items-center u-gap-1">
...
<script lang="ts">
import type { BotCounts, ChecksSummary, PRStats } from '@/lib/githubClient';
...
.size-dot-1 { background: var(--size-heatmap-1); }
.size-dot-2 { background: var(--size-heatmap-2); }
.size-dot-3 { background: var(--size-heatmap-3); }
.size-dot-4 { background: var(--size-heatmap-4); }
.size-dot-5 { background: var(--size-heatmap-5); }
