<template>
  <nav
    class="pr-files-nav-bar u-flex u-items-center u-gap-2 u-fs-13 u-flex-shrink-0 u-sticky u-top-0 u-z-5"
  >
    <button
    ...
    <button
      class="pr-files-nav-btn has-tooltip u-flex-shrink-0"
    ...
    <div
      class="pr-files-dropdown u-relative u-flex-1 u-min-w-0"
      :class="{ 'file-viewed' : isCurrentFileViewed }"
    >
      <button
      ...
      >
        ...
        >
          <span
            class="pr-files-dropdown-viewed u-flex-shrink-0"
            :class="{ checked : viewedFiles[file.filename] === 'VIEWED' }"
          >✓</span>
